@charset "UTF-8";
:root { --polaris-version-number: '11.0.1'; }
...
.Polaris-LegacyCard { background-color: var(--p-color-bg); box-shadow: var(--p-shadow-md); outline: var(--p-border-width-1) solid transparent; }
